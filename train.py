...
def main():
    ...
    if args.resume:
        ...
        # 如果 checkpoint 包含 optimizer 和 scheduler 的状态，加载它们
        ...
        # 恢复其他信息（如最佳验证指标和当前 epoch）
        if 'best_val_PQ' in checkpoint:
            best_val_PQ = checkpoint['best_val_PQ']
            print(f'Best validation metric from checkpoint: {best_val_PQ}')
